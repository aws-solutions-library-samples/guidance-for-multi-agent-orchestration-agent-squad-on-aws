...
export const orderManagementAgent = new BedrockLLMAgent({
  ...
  streaming: false,
  description:
    "Handles order-related inquiries including order status, shipment tracking, returning products, and refunds. Uses order database and shipment tracking tools.",
...
export const productInfoAgent = new BedrockLLMAgent({
  ...
  streaming: false,
  description:
    "Provides detailed product information, answers general questions about product specifications, compatibility, and availability.",
